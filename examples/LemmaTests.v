...
Theorem t_err : forall a b c d, a =*> c * b =*> d ===> a =*> b * c =*> d.
  intros.
  progress sep_canceler ltac:ILTacCommon.isConst auto_ext.
  sep_canceler ltac:ILTacCommon.isConst auto_ext.
  (progress sep_canceler ltac:ILTacCommon.isConst auto_ext; fail 3) || idtac.
Abort.
*)